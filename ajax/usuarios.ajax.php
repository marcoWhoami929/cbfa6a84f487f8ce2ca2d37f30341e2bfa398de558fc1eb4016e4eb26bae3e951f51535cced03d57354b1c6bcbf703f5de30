...
class AjaxUsuarios{
	...
	public $validarEmailMayoreo;

	public function ajaxValidarEmailMayoreo(){

		$datos = $this->validarEmailMayoreo;

		$respuesta = ControladorUsuarios::ctrMostrarUsuarioMayoreo("email", $datos);
...
VALIDAR EMAIL EXISTENTE
=============================================*/	
if (isset($_POST["validarEmailMayoreo"])) {
	$valEmail = new AjaxUsuarios();
	$valEmail -> validarEmailMayoreo = $_POST["validarEmailMayoreo"];
	$valEmail -> ajaxValidarEmailMayoreo();
}
/*=============================================
REGISTRO CON FACEBOOK
=============================================*/
