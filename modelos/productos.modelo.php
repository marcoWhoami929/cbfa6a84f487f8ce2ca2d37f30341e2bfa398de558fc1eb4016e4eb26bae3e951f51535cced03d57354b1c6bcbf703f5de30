...
class ModeloProductos{
	...
	static public function mdlMostrarProductos($tabla, $ordenar, $item, $valor, $base = 0, $tope = 10000, $modo = 'DESC'){
	...
	static public function mdlMostrarInfoProducto($tabla, $item, $valor){
		...
		if ($item === 'unidad') {
			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE detalles like '%$valor%'");
		}else{
			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE $item = :$item");
	...
	static public function mdlBuscarProductos($tabla, $busqueda, $ordenar, $modo, $base, $tope){
		...
		$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla  WHERE ruta like '%$busqueda%' OR titulo like '%$busqueda%' OR tipoProducto like '%$busqueda%' OR detalles like '%$busqueda%' ORDER BY $ordenar $modo LIMIT $base, $tope");
