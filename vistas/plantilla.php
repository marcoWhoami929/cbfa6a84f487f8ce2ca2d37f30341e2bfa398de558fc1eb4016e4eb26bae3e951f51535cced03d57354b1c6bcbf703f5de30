<?php
	...
	if (is_array($rutas) && isset($rutas[0]) && $rutas[0] == 'pdf') {
		return ControladorCompras::ctrPdfCompra('vistas/modulos/pdf.php', $rutas[1]);
	}

	if (is_array($rutas) && isset($rutas[0]) && $rutas[0] == 'pdf-mayoreo') {
		return ControladorCompras::ctrPdfPedido('vistas/modulos/pdfMayoreo.php', $rutas[1]);
	}
?>
<!DOCTYPE html>
<html lang="es">
<head>
	...
	<?php
		...
		include 'extensiones/vendor/autoload.php';
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $url; ?>vistas/css/main.css">

	<link rel="stylesheet" type="text/css" href="<?php echo $url; ?>vistas/css/dataTables.bootstrap.css">

	<link rel="stylesheet" type="text/css" href="<?php echo $url; ?>vistas/css/buscador.css">
	...
	<script src="<?php echo $url; ?>vistas/js/plugins/zendesk.js"></script>

	<script src="<?php echo $url; ?>vistas/js/typeahead.js"></script>

	<script src="<?php  echo $url; ?>vistas/js/bloodhound.js"></script>

	<script src="<?php echo $url; ?>vistas/js/main.js"></script>

	<script src="<?php echo $url; ?>vistas/js/jquery.dataTables.js"></script>

	<script src="<?php echo $url; ?>vistas/js/dataTables.bootstrap.js"></script>

	<script src="<?php echo $url; ?>vistas/js/VentanaCentrada.js"></script>

	<script src="<?php echo $url; ?>vistas/js/buscar.js"></script>
...
if(isset($_GET["ruta"])){
	...
	if($ruta != null || $rutas[0] == "ofertas-del-mes" || $rutas[0] == "lo-mas-vendido" || $rutas[0] == "lo-mas-visto"){
	...
	}else if($rutas[0] == "buscador" || $rutas[0] == "verificar" || $rutas[0] =="verificarMayoreo" || $rutas[0] == "salir" || $rutas[0] == "perfil" || $rutas[0] == "perfilMayoreo" || $rutas[0] == "carrito-de-compras" || $rutas[0] == "error" || $rutas[0] == "finalizar-compra" || $rutas[0] == "finalizar-compra-payu" || $rutas[0] == "curso" || $rutas[0] == "ofertas" || $rutas[0] == "compra"){
