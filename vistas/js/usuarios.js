...
var validarEmailRepetidoMayoreo = false;

$("#regEmailMayoreo").change(function(){

	var email = $("#regEmailMayoreo").val();

	var datos = new FormData();
	datos.append("validarEmailMayoreo", email);
	...
	$.ajax({
		...
		success:function(respuesta){
			...
			if(respuesta == "false"){
				...
				$(".alert").remove();
				validarEmailRepetidoMayoreo = false;
				...
				$("#regEmailMayoreo").parent().before('<div class="alert alert-warning"><strong>ERROR:</strong> El correo electrónico ya existe en la base de datos, fue registrado a través de '+modo+', por favor ingrese otro diferente</div>')

					validarEmailRepetidoMayoreo = true;
...
VALIDAR EL REGISTRO DE USUARIO
=============================================*/
function registroUsuarioMayoreo(){
	...
	if(email != ""){
		...
		if(!expresion.test(email)){
			...
			$("#regEmailMayoreo").parent().before('<div class="alert alert-warning"><strong>ERROR:</strong> Escriba correctamente el correo electrónico</div>')

			return false;

		}

		if(validarEmailRepetidoMayoreo){

			$("#regEmailMayoreo").parent().before('<div class="alert alert-danger"><strong>ERROR:</strong> El correo electrónico ya existe en la base de datos, por favor ingrese otro diferente</div>')
		...
		$("#regEmailMayoreo").parent().before('<div class="alert alert-warning"><strong>ATENCIÓN:</strong> Este campo es obligatorio</div>')
	...
	var politicas = $("#regPoliticas1:checked").val();
	
	if(politicas != "on"){

		$("#regPoliticas1").parent().before('<div class="alert alert-warning"><strong>ATENCIÓN:</strong> Debe aceptar nuestras condiciones de uso y políticas de privacidad</div>')
