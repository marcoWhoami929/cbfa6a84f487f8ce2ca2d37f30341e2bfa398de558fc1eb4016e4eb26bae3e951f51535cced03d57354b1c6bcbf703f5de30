...
<div class="container-fluid well well-sm carr">
...
<div class="container-fluid carr2">
			...
			<?php
				...
				if(isset($_SESSION["validarSesion"])){
					...
					if($_SESSION["validarSesion"] == "ok"){
						...
						echo '<a id="btnCheckout" href="#modalCheckout" data-toggle="modal" idUsuario="'.$_SESSION["id"].'"))><button class="btn btn-default backColor btn-lg pull-right" id="btnCheckout" >REALIZAR PAGO</button></a>';
			...
			<div class="contenidoCheckout">
				...
				<div class="listaProductos row">
					...
					<div class="col-sm-6 col-xs-12 pull-right">
					 ...
					 <div class="anexos col-lg-12">
						 	<form>
							  <div class="form-group">
							    <label for="observacionesText">Observaciones</label>
							    <input type="text" class="form-control" id="observaciones" name="observaciones" aria-describedby="observaciones" placeholder="Observaciones del pedido" required="true">
							    <small id="observaciones" class="form-text text-muted">Ingrese alguna observación que desee agregar a su pedido.</small>
							  </div>
							   <div class="form-group">
							    <label for="referenciaText">Referencia</label>
							    <input type="text" class="form-control" id="referencia" name="referencia" placeholder="Referencia del pedido" required="true">
