...
======================================-->
<div class="container-fluid well well-sm info-p" id="info-prod">
...
INFOPRODUCTOS
======================================-->
<div class="container-fluid infoproducto mt140">
		...
		<div class="row">
			...
			?>
				...
				<?php
					...
					if($infoproducto["precio"] == 0){
						...
						if($infoproducto["oferta"] == 0){
							...
							echo '<h2 class="text-muted" style="color:#f0ad4e">MXN $'.$infoproducto["precio"].'.00</h2>';
							...
							echo '<h2 class="text-muted">
								...
								<span>
									...
									<strong class="oferta" style="color:#777">MXN $'.$infoproducto["precio"].'.00</strong>

								</span>

								<span>
									
									<strong class="" style="color:#f0ad4e">MXN $'.$infoproducto["precioOferta"].'</strong>
				...
				<div class="form-group row">
					<h5 style="font-weight: bold">*Nuestros precios van con iva.</h5>
					<h5 style="font-weight: bold">*Sujeto a disponibilidad y a cambios sin previo aviso.</h5>
					
					<h4 style="font-weight: bold">Detalles de producto:</h4>
				...
				<?php
						...
						if($infoproducto["tipo"] == "fisico"){
							...
							foreach($detalles["Unidad"] as $unidad => $Unidad)
							{
							...
							echo '<div class="col-xs-4">
								...
								<li>
									<h5 style="font-weight: bold">Unidad:</h5><i style="margin-right:10px" class="fa fa-cube fa-2x"></i>
									<span class="label label-primary" style="font-size:14px;">'.$Unidad.'</span>
							...
							foreach($detalles["Codigo"] as $codigo => $Codigo)
							{
							...
							echo '<div class="col-xs-4">
								...
								<li>
									...
									<h5 style="font-weight: bold">Código:</h5><i style="margin-right:10px" class="fa fa-barcode fa-2x"></i>
									<span class="label label-info" style="font-size:14px;">'.$Codigo.'</span>
							...
							switch ($Marca) {
										case 'ZAAK':
											echo "<img src='logos/zaak.png' class='img-responsive' width='30%'>";
											break;
										case 'GONI':
											echo "<img src='logos/goni.jpg' class='img-responsive' width='20%'>";
											break;
										case '3M':
											echo "<img src='logos/3m.png' class='img-responsive' width='20%'>";
											break;
										case 'EXCELO':
											echo "<img src='logos/excelo.png' class='img-responsive' width='10%'>";
											break;
										default:
											echo "Sin Marca";
											break;
					...
					=============================================*/
						...
						echo '<div class="col-md-4 col-xs-12" style="margin-top:10px;">';
									if ($infoproducto["existencias"]<=0) {

													echo '<h5 style="font-weight:bold"><span class="label label-danger" style="font-size:14px;">SIN EXISTENCIAS</span></h5>';
												}else if($infoproducto["existencias"]>=5 && $infoproducto["existencias"] < $infoproducto["stockMax"]){

													echo '<h5 style="font-weight:bold">Existencias: <span class="label label-info" style="font-size:12px;">'.$infoproducto["existencias"].'</span></h5>';
												}else if ($infoproducto["existencias"]>=5 && $infoproducto["existencias"] > $infoproducto["stockMax"]) {

													echo '<h5 style="font-weight:bold">Existencias: <span class="label label-info" style="font-size:12px;">'.$infoproducto["existencias"].'</span></h5>';
												}

												else if($infoproducto["existencias"]<5 && $infoproducto["existencias"] > $infoproducto["stockMin"]){
													echo '<h5 style="font-weight:bold">Existencias: <span class="label label-warning" style="font-size:12px;">'.$infoproducto["existencias"].'</span></h5>';
												}
				...
				<?php
					...
					if($infoproducto["precio"]==0){
						...
						if($infoproducto["tipo"]=="fisico" && $infoproducto["oferta"] != 0 && $infoproducto["existencias"]>0){

							echo '<div class="col-md-6 col-xs-12">

								<button class="btn btn-default btn-block btn-lg backColor agregarCarrito"  idProducto="'.$infoproducto["id"].'" imagen="'.$servidor.$infoproducto["portada"].'" titulo="'.$infoproducto["titulo"].'" precio="'.$infoproducto["precioOferta"].'" tipo="'.$infoproducto["tipo"].'" peso="'.$infoproducto["peso"].'" existencias="'.$infoproducto["existencias"].'">
						...
						}else if ($infoproducto["tipo"]=="fisico" && $infoproducto["oferta"] !=0 && $infoproducto["existencias"]<=0) {
							
							echo '<div class="alert alert-danger" role="alert">Si desea el producto, Envienos un correo electrónico y nosotros nos pondremos en contacto.<button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal">Solicitar producto</button> </div>';
							...
							echo '<div class="col-lg-6 col-md-8 col-xs-12">
									...
									<button class="btn btn-default btn-block btn-lg backColor agregarCarrito"  idProducto="'.$infoproducto["id"].'" imagen="'.$servidor.$infoproducto["portada"].'" titulo="'.$infoproducto["titulo"].'" precio="'.$infoproducto["precio"].'" tipo="'.$infoproducto["tipo"].'" peso="'.$infoproducto["peso"].'" existencias="'.$infoproducto["existencias"].'">
...
<!--========================================
	VENTANA MODAL PARA MANDAR CORREO
=======================================-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background: #000000">
        ...
        <h4 class="modal-title" id="myModalLabel"><p style="font-size: 15px; font-weight: bolder; color: #ffffff;text-align: center;">SOLICITUD DE PRODUCTO</p></h4><br>
      ...
      <div class="modal-body">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 formContacto">
				...
				<form role="form" method="post" onsubmit="return validarContactenos()">
			  		...
			  		<input type="text" id="nombreContactenos" name="nombreContactenos" class="form-control" placeholder="Escriba su nombre" required> 
	       			...
	       			<textarea id="mensajeContactenos" name="mensajeContactenos" class="form-control" placeholder="Escriba su mensaje" rows="5" required>Se solicita el alta del producto para realizar el proceso de compra <?php echo $infoproducto["titulo"]?></textarea>
				...
				<?php 
					...
					$contactenos -> ctrFormularioSolicitudProducto();
      ...
      <div class="modal-footer">
        <button type="button" style="float: left;" class="btn btn-info" data-dismiss="modal">CERRAR</button>
      </div>
    </div>
  </div>
</div>
