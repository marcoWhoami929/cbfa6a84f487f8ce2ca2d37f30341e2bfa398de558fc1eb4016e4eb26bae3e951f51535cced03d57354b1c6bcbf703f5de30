...
BREADCRUMB OFERTAS
======================================-->
<div class="container-fluid well well-sm ofert">
					 	...
					 	<div class="jumbotron">
					 		...
					 		<h1 class="text-center">¡Hola! :)</h1> 
					 		 ...
					 		 <p class="text-center">
								...
								Tu compra ha sido realizada con éxito, pero antes queremos presentarte las siguientes ofertas, si no deseas ver las ofertas y continuar visualizando la compra que acabas de realizar haz click en el siguiente botón:
								<br><br>
								<a href="'.$url.'perfil">
								...
								<div class="ofertas">
									...
									<figure>
										...
										if($value["descuentoOferta"] != 0){
											...
											echo '<h1 class="text-center text-uppercase">'.$value["descuentoOferta"].' % DE DESCUENTO</h1>';
